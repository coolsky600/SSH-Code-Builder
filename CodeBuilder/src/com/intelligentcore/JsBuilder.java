...
public class JsBuilder {
	...
	public static String getJsCode(String tableName, List<Map<String, String>> cil){
		InputStream is= CodeBuilder.class.getClassLoader().getResourceAsStream("Js.Template");
