...
public class DAOImplBuilder {
	...
	public static String getDaoImplCode(String tableName, List<Map<String, String>> cil){
		InputStream is= CodeBuilder.class.getClassLoader().getResourceAsStream("DaoImpl.Template");
