...
public class ActionBuilder {
	...
	public static String getActionCode(String tableName, List<Map<String, String>> cil){
		InputStream is= CodeBuilder.class.getClassLoader().getResourceAsStream("Action.Template");
