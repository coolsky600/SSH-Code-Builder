...
public class DAOBuilder {
	...
	public static String getDaoCode(String tableName, List<Map<String, String>> cil){
		InputStream is= CodeBuilder.class.getClassLoader().getResourceAsStream("Dao.Template");
